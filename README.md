...
As a side effect, the accent color now appears as a selection color or on selected buttons, where it would be gray in default Adwaita. For example in Nautilus – in the side panel, when selecting folders. I'm gonna keep that since it might be better. If someone cares about it being removed, do tell.
